...
\begin{abstract}
  ...
  above results, we analyze different benchmarks and real-world datasets, including LUBM
  and the YAGO ontology, and show that for many
...
Guilin Qi was partially supported by NSFC
