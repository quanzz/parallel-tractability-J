...
\begin{abstract}
  ...
  well for some ontologies, although the reasoning problem for the
  ...
  above results, we analyze benchmark and real-world datasets, including the LUBM
  and the YAGO ontologies, and show that for many
  ...
  shows comparable performance with compared to the highly optimized
  state-of-the-art reasoner RDFox.
\end{abstract}
...
\input{parallelTractabilityDatalog}

\input{parallelTractabilityOntMat}
